...
function Trem.novo(world, razao)
	...
	-- First wheel
	local wheel1 = {}
	wheel1.body = love.physics.newBody(world, 25 + trem.width/4.0, trem.height/2.0 + trem.y0, "dynamic")
	...
	-- Second wheel
	local wheel2 = {}
	wheel2.body = love.physics.newBody(world, 25 + trem.width*1.5/2.0, trem.height/2.0 + trem.y0, "dynamic")
	...
	trem.wheeljoint1 = love.physics.newRevoluteJoint(trem.body, wheel1.body, 25 + trem.width/4.0, trem.height/2.0 + trem.y0)
	...
	trem.wheeljoint1:setMaxMotorTorque(100000) -- Following example from http://www.emanueleferonato.com/2011/08/22/step-by-step-creation-of-a-box2d-cartruck-with-motors-and-shocks/

	-- Create joint between car body and second wheel
	trem.wheeljoint2 = love.physics.newRevoluteJoint(trem.body, wheel2.body, 25 + trem.width*1.5/2.0, trem.height/2.0 + trem.y0)
	trem.wheeljoint2:setMotorEnabled(true);
	trem.wheeljoint2:setMaxMotorTorque(100000)
